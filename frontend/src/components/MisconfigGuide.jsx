...
const STAGE_META = {
  ...
  "Stage 3": { label: "Application Decomp.",     color: "#4ea8a0", icon: "III" },
      ...
      <div style={{ maxWidth: 860, margin: "0 auto" }}>
        ...
        <div style={{ marginBottom: 40 }}>
          ...
          <p style={{ color: TEXT_DIM, fontSize: 15, margin: "8px 0 0", lineHeight: 1.7, maxWidth: 620 }}>
            Every security check MicroSOC monitors — with business impact in plain language, step-by-step remediation, and authoritative references from CISA, NIST, and the FBI IC3.
